package test.KabOOm356.Permission;
...
public class ModLevelTest
{
	...
	{
		assertTrue(ModLevel.compareToByLevel(ModLevel.UNKNOWN, ModLevel.UNKNOWN) == 0);
		...
		assertTrue(ModLevel.compareToByLevel(ModLevel.NONE, ModLevel.NONE) == 0);
		...
		assertTrue(ModLevel.compareToByLevel(ModLevel.LOW, ModLevel.LOW) == 0);
		...
		assertTrue(ModLevel.compareToByLevel(ModLevel.NORMAL, ModLevel.NORMAL) == 0);
		...
		assertTrue(ModLevel.compareToByLevel(ModLevel.HIGH, ModLevel.HIGH) == 0);
	}
	
	@Test
	public void testCompareToByLevelModLevel()
	{
		assertTrue(ModLevel.UNKNOWN.compareToByLevel(ModLevel.UNKNOWN) == 0);
		...
		assertTrue(ModLevel.NONE.compareToByLevel(ModLevel.NONE) == 0);
		...
		assertTrue(ModLevel.LOW.compareToByLevel(ModLevel.LOW) == 0);
		...
		assertTrue(ModLevel.NORMAL.compareToByLevel(ModLevel.NORMAL) == 0);
		...
		assertTrue(ModLevel.HIGH.compareToByLevel(ModLevel.HIGH) == 0);
	}
}
