...
public class FormattingUtilTest {
  ...
  public void testAppendCharacterAfterStringCharCharInt() {
    ...
    for (int LCV = 0; LCV < 100; LCV++) {
      final String returned =
          FormattingUtil.appendCharacterAfter(str, newLineCharacter, tabCharacter, LCV);
  ...
  public void testAddCharacterToNewLinesStringCharInt() {
    ...
    for (int LCV = 0; LCV < 100; LCV++) {
      final String returned =
          FormattingUtil.addCharacterToNewLines(str, FormattingUtil.tabCharacter, LCV);
  ...
  private void testCharacterInsertion(
    ...
    // (number of additions * the number of times inserted) + number of times the character appears
    // before insertion
  ...
  public void testFormatTimeRemaining() {
    ...
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 1));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 1));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 1));

    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 60));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 60));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 60));

    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 61));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 61));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 61));

    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 3600));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 3600));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 3600));

    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 3601));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 3601));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 3601));

    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 3660));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 3660));
    assertEquals(
        ChatColor.GOLD + "0" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 3660));

    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%h", 3661));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%m", 3661));
    assertEquals(
        ChatColor.GOLD + "1" + ChatColor.WHITE, FormattingUtil.formatTimeRemaining("%s", 3661));
