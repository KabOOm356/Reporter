...
public class ReportInformationServiceTest extends ServiceTest {
  ...
  @After
  public void verifyDatabaseMocks()
  ...
  @Test
  public void getViewableReportsUUIDLookup()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test
  public void getCompletedReportIndexes()
  ...
  @Test
  public void getIncompleteReportIndexes()
      throws InterruptedException, SQLException, ClassNotFoundException {
    when(getDatabaseHandler().sqlQuery(eq(connectionId), anyString())).thenReturn(sqlResultSet);
  ...
  @Test
  public void getIndexesOfPriority()
      throws InterruptedException, SQLException, ClassNotFoundException {
    when(getDatabaseHandler().sqlQuery(eq(connectionId), anyString())).thenReturn(sqlResultSet);
