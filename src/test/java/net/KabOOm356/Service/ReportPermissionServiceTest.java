...
public class ReportPermissionServiceTest extends ServiceTest {
  ...
  @Mock private CommandSender claimingPlayerSender;

  @Mock private ReportInformationService informationManager;
  ...
  @Test
  public void canAlterReportSenderOnly()
  ...
  @Test
  public void canAlterReportClaimedPriorityFail()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test
  public void canAlterReportPass()
      throws InterruptedException, SQLException, ClassNotFoundException {
    doReturn(true).when(manager).requirePriority(sender, 1, sender);
  ...
  public void canAlterReportInterruptedException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  public void canAlterReportSQLException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  public void canAlterReportClassNotFoundException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test
  public void requireUnclaimedOrPriorityUnclaimed()
      throws InterruptedException, SQLException, ClassNotFoundException {
    assertTrue(manager.requireUnclaimedOrPriority(sender, 1, sender));
  }

  @Test
  public void requireUnclaimedOrPriorityClaimedWithHigherPriority()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test
  public void requireUnclaimedOrPriorityClaimedWithLowerPriority()
      throws InterruptedException, SQLException, ClassNotFoundException {
    resultRow.put("ClaimStatus", true);
    final CommandSender player = mock(CommandSender.class);
  ...
  @Test
  public void requireUnclaimedOrPriorityClaimedBySender()
      throws InterruptedException, SQLException, ClassNotFoundException {
    final CommandSender player = mock(CommandSender.class);
    resultRow.put("ClaimStatus", true);
    when(playerService.getModLevel(player)).thenReturn(ModLevel.HIGH);
  ...
  @Test
  public void requireUnclaimedOrPriorityClaimedByPlayer()
      throws InterruptedException, SQLException, ClassNotFoundException {
    final CommandSender player = mock(CommandSender.class);
    resultRow.put("ClaimStatus", true);
    when(playerService.getModLevel(player)).thenReturn(ModLevel.HIGH);
  ...
  @Test(expected = ClassNotFoundException.class)
  public void requireUnclaimedOrPriorityClassNotFoundException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = SQLException.class)
  public void requireUnclaimedOrPrioritySQLException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = InterruptedException.class)
  public void requireUnclaimedOrPriorityInterruptedException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = InterruptedException.class)
  public void checkPriorityInterruptedException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = ClassNotFoundException.class)
  public void checkPriorityClassNotFoundException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = SQLException.class)
  public void checkPrioritySQLException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test
  public void requirePriorityFailSameSender()
      throws InterruptedException, SQLException, ClassNotFoundException {
    when(getLocale().getString(any(LocalePhrase.class))).thenAnswer(LocaleEntryAnswer.instance);
  ...
  @Test
  public void requirePriorityFailDifferentSender()
      throws InterruptedException, SQLException, ClassNotFoundException {
    when(getLocale().getString(any(LocalePhrase.class))).thenAnswer(LocaleEntryAnswer.instance);
    final CommandSender player = mock(CommandSender.class);
  ...
  @Test(expected = SQLException.class)
  public void requirePrioritySQLException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = ClassNotFoundException.class)
  public void requirePriorityClassNotFoundException()
      throws InterruptedException, SQLException, ClassNotFoundException {
  ...
  @Test(expected = InterruptedException.class)
  public void requirePriorityInterruptedException()
      throws InterruptedException, SQLException, ClassNotFoundException {
