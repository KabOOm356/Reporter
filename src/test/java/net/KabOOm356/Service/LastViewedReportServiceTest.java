...
public class LastViewedReportServiceTest extends ServiceTest {
  ...
  @Test
  public void getIndexOrLastViewedReportLast()
  ...
  @Test
  public void getIndexOrLastViewedReportIndex()
      throws NoLastViewedReportException, IndexNotANumberException {
    final CommandSender sender = mock(CommandSender.class);
    lastViewed.put(sender, 5);
  ...
  @Test(expected = NoLastViewedReportException.class)
  public void getIndexOrLastViewedReportNoLastReport()
      throws NoLastViewedReportException, IndexNotANumberException {
    final CommandSender sender = mock(CommandSender.class);
    when(sender.getName()).thenReturn("testPlayer");
  ...
  public void getIndexOrLastViewedReportIndexNotANumber()
      throws NoLastViewedReportException, IndexNotANumberException {
    final CommandSender sender = mock(CommandSender.class);
  ...
  @Test(expected = IllegalArgumentException.class)
  public void getIndexOrLastViewedReportNullSender()
      throws NoLastViewedReportException, IndexNotANumberException {
    manager.getIndexOrLastViewedReport(null, "1");
  }

  @Test(expected = IllegalArgumentException.class)
  public void getIndexOrLastViewedReportNullIndex()
      throws NoLastViewedReportException, IndexNotANumberException {
    manager.getIndexOrLastViewedReport(mock(CommandSender.class), null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void getIndexOrLastViewedReportEmptyIndex()
      throws NoLastViewedReportException, IndexNotANumberException {
  ...
  /**
   * Method to help verify if the sender has a last viewed report. The logic of the should match or
   * be similar to the logic in {@link LastViewedReportService#hasLastViewed(CommandSender)}. But
   * for testing purposes we should not rely on the manager logic.
   */
