 ...
 * net.KabOOm356.Command.Commands.DowngradeCommand}.
 */
public abstract class DowngradePhrases {
  /** The report at index %i is already at the lowest priority! */
  public static final LocalePhrase reportIsAtLowestPriority =
      new LocalePhrase(
          "reportIsAtLowestPriority", "The report at index %i is already at the lowest priority!");

  /** /report downgrade Index/last */
  public static final LocalePhrase downgradeHelp =
      new LocalePhrase("downgradeHelp", "/report downgrade <Index/last>");

  /** Moves the specified report down to the next lowest priority. */
  public static final LocalePhrase downgradeHelpDetails =
      new LocalePhrase(
