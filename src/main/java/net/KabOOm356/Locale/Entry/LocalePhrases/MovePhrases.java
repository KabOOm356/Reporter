 ...
 * {@link net.KabOOm356.Command.Commands.MoveCommand}.
 */
public abstract class MovePhrases {
	 ...
	 */
	public static final LocalePhrase moveReportSuccess = new LocalePhrase(
			"moveReportSuccess",
			"The report at index %i was successfully moved to priority %p!");
	 ...
	 */
	public static final LocalePhrase moveHelp = new LocalePhrase(
			"moveHelp",
			"/report move <Index/last> <Priority>");
	 ...
	 */
	public static final LocalePhrase moveHelpDetails = new LocalePhrase(
			"moveHelpDetails",
			"Moves the specified report to a new priority.  Priority can be None, Low, Normal or High.");
}
