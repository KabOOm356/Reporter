 ...
 * net.KabOOm356.Command.Commands.UpgradeCommand}.
 */
public abstract class UpgradePhrases {
  /** The report at index %i is already at the highest priority! */
  public static final LocalePhrase reportIsAtHighestPriority =
      new LocalePhrase(
          "reportIsAtHighestPriority",
          "The report at index %i is already at the highest priority!");

  /** /report upgrade Index/last */
  public static final LocalePhrase upgradeHelp =
      new LocalePhrase("upgradeHelp", "/report upgrade <Index/last>");

  /** Moves the specified report up to the next highest priority. */
  public static final LocalePhrase upgradeHelpDetails =
      new LocalePhrase(
