...
public class ReportTableVersion7 extends DatabaseTableVersionMigrator {
	...
	public ReportTableVersion7(final Database database, final String tableName) {
		...
		this.creator = new ReportTableVersion7Creator(getDatabase(), getDatabaseVersion(), getTableName());
	}
	...
	private final static class ReportTableVersion7Creator extends DatabaseTableCreator {
		private ReportTableVersion7Creator(final Database database, final String databaseVersion, final String tableName) {
