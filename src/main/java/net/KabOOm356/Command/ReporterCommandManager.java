...
public class ReporterCommandManager implements CommandExecutor {
  ...
  public ReporterCommandManager(final Reporter plugin) {
    ...
    respondHelpDisplayBuilder
        .setHeader(HelpPhrases.respondHelpHeader)
    ...
    respondHelp =
        new HelpCommand(this, getLocale(), getRespondCommands().values(), respondHelpDisplay);
  }
  ...
  private void initCommands() {
    ...
    initReportCommand(
        new HelpCommand(this, getLocale(), getReportCommands().values(), reportHelpDisplay));

    initRespondCommand(new RespondCommand(this));
  }

  /**
   * Adds the ReporterCommand to be executed. <br>
   * <br>
  ...
  public boolean onCommand(
    ...
    final boolean isRespondCommand =
        label.equalsIgnoreCase("respond")
            || label.equalsIgnoreCase("resp")
            || label.equalsIgnoreCase("rrespond");
    ...
    // Begin Report Commands
        ...
        || label.equalsIgnoreCase("rreport")
        || label.equalsIgnoreCase("rep")) {
  ...
  public final OfflinePlayer getPlayer(final String playerName) {
    return BukkitUtil.getPlayer(
        playerName, getConfig().getBoolean("general.matchPartialOfflineUsernames", true));
  }
