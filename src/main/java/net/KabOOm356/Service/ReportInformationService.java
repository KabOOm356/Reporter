...
public class ReportInformationService extends Service {
   ...
   * @return A {@link List} of integers that contains all the report indexes the {@link
   *     CommandSender} can view.
   * @throws InterruptedException
   * @throws SQLException
   * @throws ClassNotFoundException
   */
  public List<Integer> getViewableReports(final CommandSender sender)
   ...
   *
   * @return A {@link List} of integers containing the indexes to all the completed reports in the
   *     database.
   * @throws ClassNotFoundException
   * @throws SQLException
   * @throws InterruptedException
   */
  public List<Integer> getCompletedReportIndexes()
   ...
   *
   * @return A {@link List} of integers containing the indexes to all the incomplete reports in the
   *     database.
   * @throws SQLException
   * @throws ClassNotFoundException
   * @throws InterruptedException
   */
  public List<Integer> getIncompleteReportIndexes()
   ...
   * @throws InterruptedException
   */
  public List<Integer> getIndexesOfPriority(final ModLevel level)
      throws ClassNotFoundException, SQLException, InterruptedException {
    final List<Integer> indexes = new ArrayList<>();
   ...
   * @return The priority for the report at the given index if one exists, otherwise {@link
   *     ModLevel#UNKNOWN} is returned.
   * @throws ClassNotFoundException
   * @throws InterruptedException
   * @throws SQLException
   */
  public ModLevel getReportPriority(final int index)
