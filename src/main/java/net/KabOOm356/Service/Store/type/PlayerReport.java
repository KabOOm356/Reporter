...
public class PlayerReport extends HashMap<UUID, PlayerReportQueue> {
   ...
   * @return A {@link PlayerReportQueue} containing all the players the {@link OfflinePlayer} has
   *     reported.
   */
   ...
   * @return A {@link PlayerReportQueue} containing all the players the {@link CommandSender} has
   *     reported.
   */
   ...
   */
  public void put(
      final CommandSender sender, final OfflinePlayer reported, final ReportTimer timer) {
   ...
   */
  public void put(
      final OfflinePlayer sender, final OfflinePlayer reported, final ReportTimer timer) {
