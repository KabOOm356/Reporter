...
public class ReportCountService extends Service {
   ...
   * @throws InterruptedException
   */
  public int getNumberOfPriority(final ModLevel level)
  ...
  private List<Integer> getIncompleteReportIndexes()
  ...
  private List<Integer> getCompletedReportIndexes()
      throws InterruptedException, SQLException, ClassNotFoundException {
    return getModule().getReportInformationService().getCompletedReportIndexes();
  }

  private List<Integer> getIndexesOfPriority(final ModLevel level)
      throws InterruptedException, SQLException, ClassNotFoundException {
