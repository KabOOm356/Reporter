...
public interface ConnectionPooledDatabaseInterface {
  ...
  /**
   * Closes all currently open connections. <br>
   * <br>
  ...
  /**
   * Attempts to perform a query on the database and returns a ResultSet of data. <br>
   * <br>
  ...
  /**
   * Attempts to perform a prepared query on the database that returns a ResultSet of data. <br>
   * <br>
   * <b>NOTE:</b> closeConnection() should be called after calling this method.
   *
   * @param connectionId The id of the connection to execute on.
   ...
   * @throws SQLException
   * @throws IllegalArgumentException If the number of parameters given do not match the number of
   *     parameters required.
   */
  ResultSet preparedQuery(Integer connectionId, String query, List<String> params)
      throws SQLException;
   ...
   *     parameters required.
   */
  void preparedUpdateQuery(Integer connectionId, String query, List<String> params)
      throws SQLException;
  ...
  /**
   * Returns the database's meta data. <br>
   * <br>
   * <b>NOTE:</b> closeConnection() should be called after calling this method.
   *
   * @param connectionId The id of the connection to execute on.
  ...
  /**
   * Returns the database's column meta data. <br>
   * <br>
   * <b>NOTE:</b> closeConnection() should be called after calling this method.
   *
   * @param connectionId The id of the connection to execute on.
