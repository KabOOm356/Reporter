...
public abstract class DatabaseTableUpdateHandler {
  ...
  protected DatabaseTableUpdateHandler(
  ...
  protected void addQueryToTransaction(final String query)
    ...
    if (isTransactionInProgress()) {
      ...
      final IllegalStateException exception =
          new IllegalStateException(
              String.format(
                  "There is not a valid transaction started to add query [%s] to!", query));
