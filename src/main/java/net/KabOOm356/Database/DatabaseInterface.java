...
public interface DatabaseInterface {
   ...
   *     parameters required.
   */
  ResultSet preparedQuery(String query, List<String> params)
   ...
   *     parameters required.
   */
  void preparedUpdateQuery(String query, List<String> params)
      throws ClassNotFoundException, SQLException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  ResultSet getColumnMetaData(String table)
      throws ClassNotFoundException, SQLException, InterruptedException;
