...
public final class ArrayUtil {
  ...
  /**
   * Converts a map to a String. The output format is: key1=value1, key2=value2
   *
  ...
  /**
   * Converts a map to a String. The output format is:
   * key1[elementSeparator]value1[entrySeparator]key2[elementSeparator]value2
   *
   * @param map The map to convert to a String.
   ...
   */
  public static <T extends Map<K, V>, K, V> String indexesToString(
      final T map, final String elementSeparator, final String entrySeparator) {
  ...
  public static <V, T extends Iterable<V>> String indexesToString(
      final T array, final String indexPrefix, final String indexPostfix) {
    Validate.notNull(array, "Parameter 'array' cannot be null!");
   ...
   */
  public static <T extends Iterable<V>, V> String indexesToString(
      final T array, final ChatColor indexColor, final ChatColor separatorColor) {
   ...
   * @return The string representation of the given indexes.
   */
  public static String indexesToString(
      final SQLResultSet resultSet,
      final String columnName,
      final ChatColor indexColor,
      final ChatColor separatorColor) {
